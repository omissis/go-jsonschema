...
type OneOfEnvelopeRefEnumDiscriminatorOptionalType struct {
	// Type corresponds to the JSON schema field "type".
	Type *EnvelopeType `json:"type,omitempty,omitzero" yaml:"type,omitempty" mapstructure:"type,omitempty"`
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *OneOfEnvelopeRefEnumDiscriminatorOptionalType) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
...
// UnmarshalYAML implements yaml.Unmarshaler.
func (j *OneOfEnvelopeRefEnumDiscriminatorOptionalType) UnmarshalYAML(value *yaml.Node) error {
	var raw interface{}
	if err := value.Decode(&raw); err != nil {
		return err
	}
