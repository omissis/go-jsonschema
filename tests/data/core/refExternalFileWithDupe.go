...
// UnmarshalJSON implements json.Unmarshaler.
func (j *Thing_2) UnmarshalJSON(b []byte) error {
	var v struct {
		Thing_2
	}
	if err := json.Unmarshal(b, &v); err != nil {
...
type RefExternalFileWithDupe struct {
	...
	// MyThing corresponds to the JSON schema field "myThing".
	MyThing *Thing_2 `json:"myThing,omitempty"`
}

// UnmarshalJSON implements json.Unmarshaler.
func (j *RefExternalFileWithDupe) UnmarshalJSON(b []byte) error {
	var v struct {
		RefExternalFileWithDupe
	}
	if err := json.Unmarshal(b, &v); err != nil {
		return err
	}
	*j = v.RefExternalFileWithDupe
	return nil
}
