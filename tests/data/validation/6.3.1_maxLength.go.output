...
func (j *A631MaxLength) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if v, ok := raw["myString"]; !ok || v == nil {
		return fmt.Errorf("field myString in A631MaxLength: required")
	}
	type Plain A631MaxLength
	var plain Plain
